...
public class NilRepository {
    ...
    public void saveDataInAdmiTracker(AdmiTracker admiTracker) {
        String sql = "INSERT INTO network_il.admi004_tracker (msg_id, msg_type, original_req, target, replay_count, status, invalid_msg, batch_creation_Date, batch_timestamp , version, created_time, modified_timestamp) " +
                "VALUES (:msg_id, :msg_type, :original_req , :target, :replay_count, :status, :invalid_msg, :batch_creation_Date, :batch_timestamp, :version, :created_time, :modified_timestamp )";
